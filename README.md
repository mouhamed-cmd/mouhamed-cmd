...
* 🎓 Transitioning into **AI Engineering** & **Cybersecurity**
* ☁️ Cloud-focused: AWS, Azure, and Google Cloud fundamentals
* 🔐 Strong interest in **incident response**, **data protection**, and **secure architectures**
* 🧠 Currently improving: AI workflows, automation, video/prompt systems (Kling, Suno, Runway), and storytelling

---

## 🛠️ **Skills & Tools**

* **Languages:** Python, PowerShell, JavaScript (basic), Markdown
* **Cloud:** AWS, Azure, Google Cloud
* **Security:** MFA setup, incident response workflow, data protection controls
...
* Preparing for the next step in tech + Army career
